# Lab6
***
Разделить программу из [лабораторной работы №5](dhttps://github.com/aerosolus/Lab5) на клиентский и серверный модули. Серверный модуль должен осуществлять выполнение команд по управлению коллекцией.
